...
use App\Http\Controllers\Modulo_Actividades\ReportesController;
...
Route::resource('estadistica',ReportesController::class)->name('*','Modulo_Actividades.reportes_actividades');
